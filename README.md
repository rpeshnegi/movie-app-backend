...
- make a DB in pgsql with name as you wish 
...
- After first build table should be created/added in PgSql DB, so please add a **user** in ***users*** table with `username` and `password` to authentication
- you can find APIs in ***/rest-example.http*** file
